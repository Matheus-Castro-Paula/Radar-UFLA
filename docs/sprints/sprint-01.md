...
- [ ] Problema delimitado, com público e contexto identificados.
- [ ] Proposta de valor, objetivos e limites iniciais definidos.
- [ ] Integrantes e organização de trabalho registrados.
- [ ] GitHub Project criado e linkado.
